...
protected:
    ...
    void sink_it_(const details::log_msg &msg) override
    {
        ...
        {
            err = (sd_journal_send)("MESSAGE=%.*s", static_cast<int>(length), msg.payload.data(), "PRIORITY=%d", syslog_level(msg.level),
                "SYSLOG_IDENTIFIER=%.*s", static_cast<int>(msg.logger_name.size()), msg.logger_name.data(), "CODE_FILE={}",
                msg.source.filename, "CODE_LINE=%d", msg.source.line, "CODE_FUNC={}", msg.source.funcname, nullptr);
        }
